...
var PoloGnome = function (_CryptoGnome) {
  _inherits(PoloGnome, _CryptoGnome);

  function PoloGnome() {
    _classCallCheck(this, PoloGnome);

    return _possibleConstructorReturn(this, (PoloGnome.__proto__ || Object.getPrototypeOf(PoloGnome)).apply(this, arguments));
  }

  _createClass(PoloGnome, [{
...
var poloniex = new PoloGnome(_api2.default);
